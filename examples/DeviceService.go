...
import (
	...
	goonvif "github.com/Luxc0/onvif"
	"github.com/Luxc0/onvif/device"
	sdk "github.com/Luxc0/onvif/sdk/device"
	"github.com/Luxc0/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/Luxc0/onvif/gosoap for pretty printing response
